        ...
        <sl-tab-group @sl-tab-show=${this.handleTabChange}>
          ...
          <sl-tab-panel name="terms">
            <div class="legal-content">
              ...
              <p>
                ${msg(
                  "eDoc Viewer is a web application that allows users to view and verify EU standard ASiC-E and Latvian eDoc electronic signature files (.asice, .sce, .edoc). The application processes files locally in your browser and does not upload your documents to any server.",
